...
SWEP.Animations = {
    ...
    ["fix_100"] = {
        ...
        SoundTable = {
            ...
            {s = path .. "sliderel.ogg",        t = 0.8, c = ci},
        },
        LHIK = true,
        LHIKIn = 0.2,
        LHIKEaseIn = 0.1,
    ...
    ["cycle"] = {
        ...
        SoundTable = {
            ...
            {s = {common .. "cloth_2.ogg", common .. "cloth_3.ogg", common .. "cloth_4.ogg", common .. "cloth_6.ogg", common .. "rattle.ogg"}, t = 0.4, v = 50},
    ...
    ["reload_10"] = {
        ...
        SoundTable = {
            ...
            {s = path .. "magout.ogg",        t = 0.3, c = ci},
            {s = path .. "magin.ogg",         t = 0.4, c = ci},
            {s = {common .. "cloth_2.ogg", common .. "cloth_3.ogg", common .. "cloth_4.ogg", common .. "cloth_6.ogg", common .. "rattle.ogg"}, t = 0.65},
        },
    },
    ["reload_empty_10"] = {
        ...
        SoundTable = {
            ...
            {s = {common .. "cloth_2.ogg", common .. "cloth_3.ogg", common .. "cloth_4.ogg", common .. "cloth_6.ogg", common .. "rattle.ogg"}, t = 0.5},
            {s = common .. "pistol_magdrop.ogg",  t = 0.65},
            {s = {common .. "cloth_2.ogg", common .. "cloth_3.ogg", common .. "cloth_4.ogg", common .. "cloth_6.ogg", common .. "rattle.ogg"}, t = 1.0},
            {s = path .. "sliderel.ogg",      t = 1.45, c = ci},
        },
    },
