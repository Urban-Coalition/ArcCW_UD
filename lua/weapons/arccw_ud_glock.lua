...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        SoundTable = {
            ...
            {s = common .. "magpouchin.ogg", t = 1.1, v = .35},
            {s = rottle, t = 0.5},
        },
    },
    ["reload_empty"] = {
    ...
    ["reload_empty_10"] = {
        ...
        SoundTable = {
            ...
            {s = common .. "magpouch.ogg", t = 0.3, c = ci},
    ...
    ["reload_empty_33"] = {
        ...
        SoundTable = {
            ...
            {s = common .. "magpouch.ogg", t = 0.4, c = ci},
            {s = path .. "magin_new.ogg",         t = 0.55, c = ci},
            {s = rattel, t = 0.5},
            {s = common .. "pistol_magdrop.ogg",  t = 0.65},
            {s = rottle, t = 1.3},
