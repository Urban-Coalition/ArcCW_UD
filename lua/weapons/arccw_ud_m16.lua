...
SWEP.FiremodeSound = {
    ...
    path .. "selector-05.ogg",
    path .. "selector-06.ogg",
}
...
SWEP.Animations = {
    ...
    ["reload_20"] = {
        ...
        SoundTable = {
            {s = rottle,  t = 0.0},
            {s = ratel, t = 0.05},
            {s = path .. "magout_20.ogg", 	 t = 0.09},
            {s = path .. "magpouch_20.ogg", t = 0.4},
            {s = rottle,  t = 0.75},
            {s = ratel, t = 0.85},
    ...
    ["reload_empty_20"] = {
        ...
        SoundTable = {
            ...
            {s = rottle, t = 0.01},
            {s = ratel, t = 0.05},
            {s = path .. "magout_20.ogg", 	 t = 0.075},
            {s = rottle, t = 0.75},
            {s = ratel, t = 0.9},
            {s = common .. "rifle_magdrop.ogg",  t = 0.65},
            {s = path .. "struggle_20.ogg",    t = 0.8, v = 0.4},
            {s = path .. "magin_20.ogg",    t = 0.85},
            {s = rottle, t = 1.4},
            {s = ratel, t = 1.4},
            {s = path .. "chamber_press_20.ogg", t = 1.52},
